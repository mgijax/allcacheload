...
def qcreport():
        ...
        fp.write(str.ljust('symbol', 35) + TAB)
        fp.write(str.ljust('parentCellLine', 25) + TAB)
        fp.write(str.ljust('sooKey', 5) + TAB)
        fp.write(str.ljust('alleleStrain', 25) + TAB)
        fp.write(str.ljust('parentKey', 10) + TAB)
        fp.write(str.ljust('parentStrain', 25) + CRT)

        fp.write(str.ljust('------', 35) + TAB)
        fp.write(str.ljust('--------------', 25) + TAB)
        fp.write(str.ljust('------', 5) + TAB)
        fp.write(str.ljust('------------', 25) + TAB)
        fp.write(str.ljust('---------', 10) + TAB)
        fp.write(str.ljust('------------', 25) + CRT*2)

        results = db.sql('select * from toUpdate1 order by sooKey, parentStrain', 'auto')
        for r in results:

            fp.write(str.ljust(r['symbol'], 35) + TAB)
            fp.write(str.ljust(r['parentCellLine'], 25) + TAB)
            fp.write(str.ljust(str(r['sooKey']), 5) + TAB)
            fp.write(str.ljust(r['alleleStrain'], 25) + TAB)
            fp.write(str.ljust(str(r['parentKey']), 10) + TAB)
            fp.write(str.ljust(r['parentStrain'], 25) + CRT)
        ...
        fp.write(str.ljust('symbol', 35) + TAB)
        fp.write(str.ljust('mutantCellLine', 25) + TAB)
        fp.write(str.ljust('parentCellLine', 25) + TAB)
        fp.write(str.ljust('mutantKey', 10) + TAB)
        fp.write(str.ljust('mutantStrain', 25) + TAB)
        fp.write(str.ljust('parentKey', 10) + TAB)
        fp.write(str.ljust('parentStrain', 25) + CRT)
        ...
        for r in results:
            ...
            fp.write(str.ljust(r['symbol'], 35) + TAB)
            fp.write(str.ljust(r['mutantCellLine'], 25) + TAB)
            fp.write(str.ljust(r['parentCellLine'], 25) + TAB)
            fp.write(str.ljust(str(r['mutantKey']), 10) + TAB)
            fp.write(str.ljust(r['mutantStrain'], 25) + TAB)
            fp.write(str.ljust(str(r['parentKey']), 10) + TAB)
            fp.write(str.ljust(r['parentStrain'], 25) + CRT)
